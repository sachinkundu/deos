# SAC-182 heartbeat failure recovery

*2026-09-14T18:31:57Z by Showboat 0.6.1*
<!-- showboat-id: deadced0-e43f-426a-88ba-7a6a559f81e8 -->

```bash
rtk proxy docker run --rm -i --platform linux/amd64 --network none --entrypoint node deos-sac172-heartbeat:latest --input-type=module < docs/evidence/sac-172/supervisor-io-probe.mjs
```

```output
{"platform":"linux","architecture":"x64","overlappingWrites":500,"captureNames":"actual packaged supervisor","result":"passed"}
```
  ...
  "implementation_tries": [
    {
      ...
      "updated_at": "2026-09-14T18:37:04.713Z"
    },
    {
      "attempt_id": "01a0a0d7-0ea0-715b-bf5e-a57a8c14965c",
      "try_sequence": 4,
  ...
  "task_progress": [
    {
      ...
      "observed_at": "2026-09-14T18:37:22.339Z"
    },
    {
      "attempt_id": "01a0a0d7-0ea0-715b-bf5e-a57a8c14965c",
      "completed": 0,
