# SAC-182 task progress signal and live meter

*2026-09-14T16:20:14Z by Showboat 0.6.1*
<!-- showboat-id: 254b077d-abf0-4226-8efc-c5015b329f9e -->
...
```output
{
  "deployments": {
    "deos-queue-consumer-ts": {
      "versions": [
        {
          "version_id": "f15c90ec-e13d-48f4-9b80-f12b0377d56b",
          "percentage": 100
        }
      ],
      "created_on": "2026-09-14T16:10:42.459731Z"
    },
    "deos-sample-project": {
      "versions": [
        {
