...
The reusable integration procedure and PR evidence-packaging rules are maintained
in [`docs/linear-cloudflare-e2e-lessons.md`](docs/linear-cloudflare-e2e-lessons.md).
Follow its evidence-layering guidance and repeatable runbook; the former local
`skills/` copies were removed and must not be referenced.
