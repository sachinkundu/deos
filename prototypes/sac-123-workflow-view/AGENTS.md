...
- Link a full agent transcript only when its exact private durable object and checksum have been read back. Keep the destination authenticated, retain the human-readable highlights, and never copy the raw transcript into the prototype.
