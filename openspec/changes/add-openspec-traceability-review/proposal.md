...
- Finish every form, structure, and readability check before a semantic check. These checks report problems but do not edit the plan. If they fail, the author coding agent Codex repairs the plan before the semantic check starts. Do not change plan text after a semantic pass.
