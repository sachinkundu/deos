...
- [x] 16.2 Add regression coverage where the saved D1 repository differs from the deployment seed, then validate, deploy, and read back the live mapping before another provider test.
...
- [x] 17.2 Advance the immutable simple definition, update the exact prompt fixture and regression coverage, validate, deploy, then re-arm SAC-130 and prove a GitHub pull request is created.
