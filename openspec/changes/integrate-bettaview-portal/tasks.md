...
- [x] 4.5 Route every later human-requested planning revision from author update to publication and an exact-head trace refresh, then back to the repeatable Human Review gate, without another author self-review or external-discovery cycle.
