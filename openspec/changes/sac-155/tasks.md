...
- [x] 4.3 Complete credential cutover and run the deliberate no-feature-change production release with 100 percent version read-back.
- [x] 4.4 Prove a later main-only update changes staging while production stays on the released version.
- [x] 4.5 Package implementation, checks, and remaining rollout status in one pull request.
