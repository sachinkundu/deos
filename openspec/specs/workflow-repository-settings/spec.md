# Workflow Repository Settings Specification

## Purpose
Let an allowed operator save and read back the project repository and guarded workflow controls that DEOS freezes for new runs.
