...
ADD COLUMN label_selection_evidence_json TEXT;

ALTER TABLE deliveries
ADD COLUMN label_selection_evidence_digest TEXT;
...
ALTER TABLE orchestration_runs
ADD COLUMN selection_label_name TEXT;

ALTER TABLE orchestration_runs
ADD COLUMN selection_reason TEXT
CHECK (selection_reason IN (
    'label_match', 'label_absent', 'label_evidence_unavailable', 'selector_disabled'
));
