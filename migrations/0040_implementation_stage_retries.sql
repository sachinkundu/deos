-- Preserve existing retries while adding the two implementation agent stages.
CREATE TABLE agent_stage_retries_implementation_next (
...
INSERT INTO agent_stage_retries_implementation_next
SELECT * FROM agent_stage_retries;

DROP TABLE agent_stage_retries;
ALTER TABLE agent_stage_retries_implementation_next RENAME TO agent_stage_retries;
