CREATE TABLE agent_stage_retries_portal_next (
...
INSERT INTO agent_stage_retries_portal_next
SELECT * FROM agent_stage_retries;

DROP TABLE agent_stage_retries;
ALTER TABLE agent_stage_retries_portal_next RENAME TO agent_stage_retries;
