CREATE TABLE publication_stage_retries (
    retry_id TEXT PRIMARY KEY,
    run_id TEXT NOT NULL,
    failed_attempt_id TEXT NOT NULL UNIQUE,
    retry_node TEXT NOT NULL,
    ...
    FOREIGN KEY (failed_attempt_id) REFERENCES workflow_transitions_v2(transition_id)
);

CREATE INDEX publication_stage_retries_run_created ON publication_stage_retries (run_id, created_at);
